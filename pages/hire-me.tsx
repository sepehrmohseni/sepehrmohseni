          ...
          >
            ...
            >
              ...
              <Typography component='p' variant='body1'>
                If you want to run a startup, if you need a single page website,
                if you have some backend that needs some front, if you hame some
                frontend that needs back, or if you want a cross platform mobile
                application... I&apos;m your guy so email me!
              </Typography>
            </Box>
          </Grid>
